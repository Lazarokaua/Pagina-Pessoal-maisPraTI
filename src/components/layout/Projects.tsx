...
export function Projects() {
    return (
        <section id="project" className="relative overflow-x-hidden">
            <div className="absolute -z-10 top-0 left-0 w-full h-full bg-gradient-to-br from-[#e0f7fa]/40 via-white/60 to-[#f3e8ff]/40 blur-2xl opacity-70 animate-pulse-slow" />
            <h2 className="font-suisse font-bold text-center text-2xl md:text-3xl lg:text-4xl tracking-wide mb-12 md:mb-16 lg:mb-20 transition-all duration-300 text-slate-700 drop-shadow-lg">Projetos</h2>
